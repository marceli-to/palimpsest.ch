...
Route::get('mentions-legales', [PageController::class, 'imprint'])->name('fr.page.imprint');
Route::get('de/impressum', [PageController::class, 'imprint'])->name('de.page.imprint');
Route::get('en/imprint', [PageController::class, 'imprint'])->name('en.page.imprint');
