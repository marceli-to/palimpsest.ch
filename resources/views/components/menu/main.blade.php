...
<div 
  class="bg-royal fixed z-50 left-0 top-78 lg:top-114 pl-16 lg:px-0 flex flex-col justify-between w-full"
  x-cloak 
  x-show="show_menu">
  <div class="pb-16 lg:pb-0 h-dvh lg:h-screen max-h-[calc(100dvh_-_78px)] lg:max-h-[calc(100dvh_-_114px)] overflow-y-auto" data-simplebar>
