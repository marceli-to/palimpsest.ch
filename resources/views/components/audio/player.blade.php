...
<div 
  ...
  <div class="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6 lg:flex-1">
    <div class="flex items-center gap-4 flex-1">
      <div class="relative flex-1 h-3 bg-white rounded cursor-pointer" data-progress-container>
        <span class="text-xxs opacity-70 absolute left-0 top-14" data-current-time>0:00</span>
        ...
        <span class="text-xxs opacity-70 absolute right-0 top-14" data-duration>12:45</span>
      </div>
    </div>

    <div class="flex justify-center lg:justify-start items-center gap-20 mt-16 lg:mt-0">
      <button data-rewind>
        <x-audio.icons.rewind />
      </button>
      <button data-play class="w-32 h-32 flex items-center justify-center">
        <x-audio.icons.play />
        <x-audio.icons.pause class="hidden" />
      </button>
      <button data-forward>
        <x-audio.icons.forward />
      </button>
    </div>
  </div>
</div>